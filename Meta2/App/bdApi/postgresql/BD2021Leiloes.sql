...
values  (1, 'user1', 'user1@email2.com', '$pbkdf2-sha256$30000$Z2yNMaa0Vsr5n/Nei1EKoQ$QaWn1eEW0I4kmX81uP0zTN0PP30nxu3GYG00dyje6Yo', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjEsImV4cCI6MTYyMjI5NTcyN30.3kfRFmZoJj1qb183rv6f0JAtVOQ6gBy8LV4c8SHBYmI'),
        (4, 'user3', 'user3@email2.com', '$pbkdf2-sha256$30000$yhmDUMrZu3eOUQrh/F9L6Q$az.zL5D69gmA.pm.CapgpXbNGGQtJ3GHzuE1beENJF4', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjQsImV4cCI6MTYyMjI5NTczM30.1TrVqi1cipxsPMUN042iyB20miif_I8dPWjqEslJ2-o'),
        (5, 'user4', 'user4@email2.com', '$pbkdf2-sha256$30000$s9bae..dk9I6ZwzB2Pu/9w$8TLpsQQt21ACH/ujQ5sOFd2pEeZgGY.XrwrRiwkYzIQ', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjUsImV4cCI6MTYyMjI5NTczNn0.GiOhyy7qKv1EyUT5p-uEjvlZN3S2KTfoZAGKjNZMU2U'),
        (6, 'user5', 'user5@email2.com', '$pbkdf2-sha256$30000$/38PgTCmNOb833svBeA85w$aK0XSHR/5y2XHyFfZBwONkodGRMzjH1HHNlyp76d1i8', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjYsImV4cCI6MTYyMjI5NTczOX0.ZV9l0ZFK_450PbAHH3NsMwlPMX8hxeQMxuNBDvZQmbE'),
        (7, 'user6', 'user6@email2.com', '$pbkdf2-sha256$30000$JaR0TmktxVirtdb6H0PI.Q$BecJg9oIMQVjfj4DgIp94escGFdJStWJ.HhsLxPXIZ0', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjcsImV4cCI6MTYyMjI5NTc0Mn0.JnONCzuqr9t3IKa2aOiL3g_JjvXsn_9SNXqIlrhBTxs'),
        (8, 'user7', 'user7@email2.com', '$pbkdf2-sha256$30000$fS/l/H8PwRjjPOd8T6nV.g$WhQMd4W6RkjphVVTHiiXDP3MLIcqrbDmNKE4aE1d4fg', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjgsImV4cCI6MTYyMjI5NTc0NX0.ZF3uOM-BPLDCepHqjLlEuMJHM8K_gqc42mrMfyKNcJ0'),
        (9, 'user8', 'user8@email2.com', '$pbkdf2-sha256$30000$wpgzBuA8xxhjDMH4X0sJAQ$4dES14Cl62iEtK9BHWoDJLs/v1f8yL9bFZ/JJWjuOe0', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjksImV4cCI6MTYyMjI5NTc0OH0.3z-3iLpz75weqSnnFftDPnHnMsqc_GFQo7yF5Hwo7tE'),
        (10, 'user9', 'user9@email2.com', '$pbkdf2-sha256$30000$n5My5ty79/4/xxgDgLCW8g$0zo1zf00A6DYvc.E/DA.X.sFhXabanKbvvm4TW.j3dk', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjEwLCJleHAiOjE2MjIyOTU3NTF9.DEZllTQ7FYF3_Zz-PYKNfMDW7_QbMVJFGY72QhVDPHI'),
        (2, 'user2', 'user2@email2.com', '$pbkdf2-sha256$30000$6P2fE6K0tra2FmLsPcc4Zw$IUcD8fkqKFArEUZ2DYkHoQVYeQKekFY3CcTHgmhE.zY', null, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyaWQiOjIsImV4cCI6MTYyMjI5NTczMH0.jYaHT08t6YI1dTmI7hQP9xk-aVO-V5KIsGLIihg5QVc');
...
insert into leilao (leilaoid, precominimo, titulo, descricao, datafim, maiorlicitacao, admincancelou, artigoid, nomeartigo, vendedor_utilizador_userid)
values  (1, 100, 'NovoTituloLeilaoNovo', 'Nova DEscricaoNovo', '2021-06-01 20:00:00.000000', 300, null, '1234654345', 'Artigo 3', 5);

insert into licitacao (id, valor, valida, momento, comprador_utilizador_userid, leilao_leilaoid)
values  (1, 115, true, '2021-05-29 12:14:26.940050', 4, 1),
        (4, 150, true, '2021-05-29 12:16:11.079487', 4, 1),
        (3, 250, true, '2021-05-29 12:15:40.013562', 6, 1),
        (2, 300, true, '2021-05-29 12:14:45.874556', 2, 1);